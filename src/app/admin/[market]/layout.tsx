...
import { MarketSwitcher } from "@/features/admin/components/market-switcher";
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* Top bar keeps market switching one click away without putting it in
         *  the primary nav — reduces accidental portal jumps mid-edit. */}
        <header className="flex items-center justify-end border-b bg-background px-6 py-2">
